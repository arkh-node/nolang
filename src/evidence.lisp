...
(defun threshold-verdict (w+ w- thr &optional (k *k*))
  "→ :passed | :reachable | :unreachable.
   :passed      — нижняя граница уже не ниже порога (решение прежнее, без изменений);
   :reachable   — порог между границами: свидетельства могут помочь;
   :unreachable — верхняя граница ниже порога: НЕ ПОМОГУТ НИКАКИЕ свидетельства,
                  сколько бы их ни пришло. Отказ окончателен по существу, а не по счёту."
